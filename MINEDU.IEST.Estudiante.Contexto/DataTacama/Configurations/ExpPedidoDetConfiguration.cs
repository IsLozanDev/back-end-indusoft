...
{
    public partial class ExpPedidoDetConfiguration : IEntityTypeConfiguration<ExpPedidoDet>
    {
        public void Configure(EntityTypeBuilder<ExpPedidoDet> entity)
        {
            ...
            entity.Property(e => e.Dscto1).HasColumnType("decimal(12, 4)");

            entity.Property(e => e.Dscto2).HasColumnType("decimal(12, 4)");

            entity.Property(e => e.Dscto3).HasColumnType("decimal(12, 4)");
            ...
            entity.Property(e => e.IdArticulo)
                ...
                .HasComment("id Articulo");

            entity.Property(e => e.IdArticuloPack).HasColumnName("idArticuloPack");
            ...
            entity.Property(e => e.IdPresentacion)
                ...
                .HasComment("id de Presentacion");

            entity.Property(e => e.IdTipoArticulo)
                .HasColumnName("idTipoArticulo")
                .HasComment("Servicio,Producto Terminado o Mercaderia");
            ...
            entity.Property(e => e.IndPack).HasColumnName("indPack");
            ...
            entity.Property(e => e.ObsNoAtender)
                .HasMaxLength(200)
                .IsUnicode(false);

            entity.Property(e => e.PorDscto1)
                .HasColumnType("decimal(9, 6)")
                .HasColumnName("porDscto1");

            entity.Property(e => e.PorDscto2)
                .HasColumnType("decimal(9, 6)")
                .HasColumnName("porDscto2");

            entity.Property(e => e.PorDscto3)
                .HasColumnType("decimal(9, 6)")
                .HasColumnName("porDscto3");
            ...
            entity.Property(e => e.PrecioConImpuesto).HasColumnType("decimal(16, 7)");

            entity.Property(e => e.PrecioUnitIni).HasColumnType("decimal(16, 7)");

            entity.Property(e => e.PrecioUnitPromocional).HasColumnType("decimal(16, 7)");

            entity.Property(e => e.PrecioUnitario).HasColumnType("decimal(16, 7)");
            ...
            entity.Property(e => e.TipArticulo)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("tipArticulo");
            ...
            entity.Property(e => e.TipoAfectacionIgv)
                .HasMaxLength(2)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.IdPresentacionNavigation)
                           .WithMany(p => p.ExpPedidoDets)
                           .HasForeignKey(d => d.IdPresentacion)
                           .HasConstraintName("FK_exp_PedidoDet_exp_Presentacion");

            entity.HasOne(d => d.IdArticuloNavegation)
                .WithMany(p => p.ExpPedidoDets)
                .HasForeignKey(d => new { d.IdEmpresa, d.IdArticulo })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_exp_PedidoDet_ArticuloServ");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<ExpPedidoDet> entity);
    }
}
