...
namespace IDCL.Tacama.Core.Contexto.IDCL.Tacama.Core.Contexto
{
    public partial class DbTacamaContext : DbContext
    {
        ...
        public virtual DbSet<ClienteAval> ClienteAvals { get; set; } = null!;
        public virtual DbSet<ClienteContacto> ClienteContactos { get; set; } = null!;
        public virtual DbSet<ClienteRepLegal> ClienteRepLegals { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new Configurations.ClienteAgenciaEnvioConfiguration());
            modelBuilder.ApplyConfiguration(new Configurations.ClienteAseguradoraConfiguration());
            modelBuilder.ApplyConfiguration(new Configurations.ClienteAsociadoConfiguration());
            modelBuilder.ApplyConfiguration(new Configurations.ClienteAvalConfiguration());
            modelBuilder.ApplyConfiguration(new Configurations.ClienteContactoConfiguration());
            modelBuilder.ApplyConfiguration(new Configurations.ClienteRepLegalConfiguration());
