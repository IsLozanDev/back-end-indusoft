...
namespace IDCL.AVGUST.SIP.Manager.Pedido
{
    public class PedidoManager : IPedidoManager
    {
        ...
        #region Call SP
        public async Task<List<GetCostoArticuloDto>> getListArticulos(int idArticulo, string idMoneda, string codigo, string fechaStock)
        {
            if (codigo == null)
            {
                codigo = "%";
            ...
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarCostoArticulo(idArticulo, idMoneda, codigo, fechaStock);

            return _mapper.Map<List<GetCostoArticuloDto>>(query);
        }

        public async Task<List<GetListaZonaVendedorDto>> ListarZonaVendedor(int idEmpresa, string Anio, string Mes, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarZonaVendedor(idEmpresa, Anio, Mes, idZona);

            return _mapper.Map<List<GetListaZonaVendedorDto>>(query);
        }

        public async Task<List<GetListaSegmentoZonaDto>> ListarSegmentoZona(int idEmpresa, string Anio, string Mes, int idZona, string Tipo)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarSegmentoZona(idEmpresa, Anio, Mes, idZona, Tipo);

            return _mapper.Map<List<GetListaSegmentoZonaDto>>(query);
        }

        public async Task<List<GetListarTopClienteDto>> ListarTopCliente(int idEmpresa, string Anio, string Mes, int idZona, string Tipo)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarTopCliente(idEmpresa, Anio, Mes, idZona, Tipo);

            return _mapper.Map<List<GetListarTopClienteDto>>(query);
        }

        public async Task<List<GetListaVentaProdutoDto>> ListarVentaProducto(int idEmpresa, string Anio, string Mes, int idZona, string Tipo, string Formato)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarVentaProducto(idEmpresa, Anio, Mes, idZona, Tipo, Formato);

            return _mapper.Map<List<GetListaVentaProdutoDto>>(query);
        }

        public async Task<List<GetListaVentaClienteProductoDto>> ListarVentaClienteProducto(int idEmpresa, string Anio, string Mes, int idZona, int idCliente, string Tipo)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarVentaClienteProducto(idEmpresa, Anio, Mes, idZona, idCliente, Tipo);
        ...
        public async Task<List<GetLineaCreditoDisponibleDto>> ListarLineaCreditoDisponibleZonaCliente(int idEmpresa, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarLineaCreditoDisponibleZonaCliente(idEmpresa, idZona);

            return _mapper.Map<List<GetLineaCreditoDisponibleDto>>(query);
        }
        
        public async Task<List<GetClientesAprobadoDto>> ListarClientesAprobadosLCPorZona(int idEmpresa, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarClientesAprobadosLCPorZona(idEmpresa, idZona);

            return _mapper.Map<List<GetClientesAprobadoDto>>(query);
        }
        
        public async Task<List<GetClientesAtendidosDto>> ListarClientesAtendidosLCPorZona(int idEmpresa, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarClientesAtendidosLCPorZona(idEmpresa, idZona);

            return _mapper.Map<List<GetClientesAtendidosDto>>(query);
        }

        public async Task<List<GetClientesAtentidosSinLCDto>> ListarClientesAtendidosSinLC(int idEmpresa, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarClientesAtendidosSinLC(idEmpresa, idZona);
        ...
        public async Task<List<GetCtaCteAtrazadaZonaDto>> ListarCtaCteAtrazadaPorZona(int idEmpresa, int idZona, string fechaFiltro)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarCtaCteAtrazadaPorZona(idEmpresa, idZona, fechaFiltro);

            return _mapper.Map<List<GetCtaCteAtrazadaZonaDto>>(query);
        }
        public async Task<List<GetLetraPorAceptarZonaDto>> ListarLetraPorAceptarZona(int idEmpresa, int idZona)
        {
            var query = await _pedidoUnitOfWork._pedidoRepository.ListarLetraPorAceptarZona(idEmpresa, idZona);
        ...
        public async Task<List<ListaPptoVentaZonaVendedor>> ListarVentasPresupuestoZonaVendedor(int idEmpresa, string anio, string mes, int idZona, string Tipo)
        {
            return await _pedidoUnitOfWork._pedidoRepository.ListarVentasPresupuestoZonaVendedor(idEmpresa, anio, mes, idZona, Tipo);
