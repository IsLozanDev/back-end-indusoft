...
namespace IDCL.AVGUST.SIP.PedidoApi.Controllers
{
    ...
    [ApiController]
    public class PedidojwtController : ControllerBase
    {
        private readonly ILogger<PedidojwtController> _logger;
        private readonly IPedidoManager _pedidoManager;


        //Api para generar JWT
        public PedidojwtController(ILogger<PedidojwtController> logger, IPedidoManager pedidoManager)
        {
            _logger = logger;
