...
namespace IDCL.AVGUST.SIP.Repository.Pedido
{
    public class PedidoRepository : GenericRepository<PedidoCab>, IPedidoRepository
    {
        ...
        public async Task<List<CostoArticulo>> ListarCostoArticulo(int idEmpresa, string idMoneda, string codArticulo, string fechaStock)
        {
        ...
        public async Task<List<ZonaVendendor>> ListarZonaVendedor(int idEmpresa, string Anio, string Mes, int idZona)
        {
        ...
        public async Task<List<SegmentoZona>> ListarSegmentoZona(int idEmpresa, string Anio, string Mes, int idZona, string Tipo)
        {
            ...
            parameters.Add("Mes", Mes, DbType.String, ParameterDirection.Input);
            parameters.Add("idZona", idZona, DbType.String, ParameterDirection.Input);
            parameters.Add("Tipo", Tipo, DbType.String, ParameterDirection.Input);

            var qResult = await _database.GetAll<SegmentoZona>(procedureName, parameters, CommandType.StoredProcedure);
            return qResult;
        }
        
        public async Task<List<ListarTopCliente>> ListarTopCliente(int idEmpresa, string Anio, string Mes, int idZona, string Tipo)
        {
        ...
        public async Task<List<VentaProducto>> ListarVentaProducto(int idEmpresa, string Anio, string Mes, int idZona, string Tipo, String Formato)
        {
            ...
            parameters.Add("idZona", idZona, DbType.String, ParameterDirection.Input);
            parameters.Add("Tipo", Tipo, DbType.String, ParameterDirection.Input);
            parameters.Add("Formato", Formato, DbType.String, ParameterDirection.Input);

            var qResult = await _database.GetAll<VentaProducto>(procedureName, parameters, CommandType.StoredProcedure);
            return qResult;
        }
        
        public async Task<List<VentaClienteProducto>> ListarVentaClienteProducto(int idEmpresa, string Anio, string Mes, int idZona, int idCliente, string Tipo)
        {
            ...
            parameters.Add("Mes", Mes, DbType.String, ParameterDirection.Input);
            parameters.Add("idZona", idZona, DbType.String, ParameterDirection.Input);
            parameters.Add("idCliente", idCliente, DbType.String, ParameterDirection.Input);
            parameters.Add("Tipo", Tipo, DbType.String, ParameterDirection.Input);
        ...
        public async Task<List<LineaCreditoDisponible>> ListarLineaCreditoDisponibleZonaCliente(int idEmpresa, int idZona)
        {
        ...
        public async Task<List<ClientesAprobados>> ListarClientesAprobadosLCPorZona(int idEmpresa, int idZona)
        {
        ...
        public async Task<List<ClientesAtendidos>> ListarClientesAtendidosLCPorZona(int idEmpresa, int idZona)
        {
        ...
        public async Task<List<ClientesAtendidosSinLC>> ListarClientesAtendidosSinLC(int idEmpresa, int idZona)
        {
        ...
        public async Task<List<CtaCteAtrazadaZona>> ListarCtaCteAtrazadaPorZona(int idEmpresa, int idZona, string fechaFiltro)
        {
        ...
        public async Task<List<LetraPorAceptarZona>> ListarLetraPorAceptarZona(int idEmpresa, int idZona)
        {
